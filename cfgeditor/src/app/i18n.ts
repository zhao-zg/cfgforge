        ...
        resources: {
            en: {
                translation: {
                    ...
                    reloadFail: 'Failed to reload: {error}',
                    ...
                    searchRecordPlaceholder: 'Search record',
                    historyPrev: 'Back (Alt+C)',
                    historyNext: 'Forward (Alt+V)',
                    refIdListEmpty: 'No related records',
                    resDirPlaceholder: 'Directory path',
                    resLangPlaceholder: 'Language code',
                    edit: 'edit',
                    undo: 'undo',
                    redo: 'redo',
                    view: 'view',
                    ...
                    chains: "Chains",
                    chainManage: "Config Chains",
                    chainLabel: "Chain name",
                    chainLabelPlaceholder: "e.g. Hero config chain",
                    chainTables: "Tables",
                    chainTablesPlaceholder: "Select tables",
                    addChain: "Add chain",
                    setChainConfs: "Save chains",
                    chainOpen: "Open chain view",
                    chainOpenFromRecord: "Open related tables",
                    ...
                    summarizeResSuccess: "Saved to {path}",
                    summarizeResFail: "Analyze resources failed: {error}",
                    savePngSuccess: "Saved PNG to {file}",
                    savePngFail: "Save PNG failed: node count too large",
                    ...
                    relationEditTitle: 'Edit Relationships',
                    fkList: 'Relationships',
                    fkAdd: 'Add Relationship',
                    fkEdit: 'Edit',
                    fkDelete: 'Delete',
                    fkName: 'Name',
                    fkNamePlaceholder: 'leave empty to auto-generate',
                    fkKeys: 'Local Keys',
                    fkRefTable: 'Target Table',
                    fkRefKeys: 'Ref Keys',
                    fkRefKeysHint: 'leave empty to reference primary key',
                    fkNullable: 'Nullable',
                    fkSave: 'Save',
            ...
            zh: {
                translation: {
                    ...
                    chainManage: '配置链管理',
                    chainLabel: '链名称',
                    chainLabelPlaceholder: '如 英雄配置链',
                    chainTables: '关联表',
                    chainTablesPlaceholder: '选择表',
                    addChain: '添加链',
                    setChainConfs: '保存配置链',
                    chainOpen: '打开链视图',
                    chainOpenFromRecord: '打开关联表',
                    tableNotFound: '表不存在',
                    toPng: '保存图片',
                    exportCsv: '导出 CSV',
                    exportSql: '导出 SQL',
                    ...
                    summarizeRes: '资源分析',
                    reloadRes: '重新加载资源',
                    summarizeResSuccess: '已保存到 {path}',
                    summarizeResFail: '资源分析失败：{error}',
                    savePngSuccess: '已保存图片到 {file}',
                    savePngFail: '保存图片失败：节点数过多',
                    cancelUpdateNote: '取消',
                    updateNote: '更新',
                    pageType: '页面',
                    ...
                    searchRecordPlaceholder: '搜索记录',
                    historyPrev: '后退 (Alt+C)',
                    historyNext: '前进 (Alt+V)',
                    refIdListEmpty: '暂无关联数据',
                    resDirPlaceholder: '目录路径',
                    resLangPlaceholder: '语言代码',
                    edit: '编辑',
                    undo: '撤销',
                    redo: '重做',
                    view: '浏览',
                    ...
                    // 关系编辑（外键）
                    editRelations: '编辑关系',
                    relationEditTitle: '编辑关系',
                    fkList: '关系列表',
                    fkAdd: '添加关系',
                    fkEdit: '编辑',
                    fkDelete: '删除',
                    fkName: '名称',
                    fkNamePlaceholder: '留空自动生成',
                    fkKeys: '本地键',
                    fkRefTable: '目标表',
                    fkRefKeys: '引用键',
                    fkRefKeysHint: '留空引用主键',
                    fkNullable: '可空',
                    fkSave: '保存',
