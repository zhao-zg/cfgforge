// To parse this data:
//
//   import { Convert, NodeShowType, KeywordColor, ShowDescriptionType, NodePlacementStrategyType, FixedRefPage, FixedUnrefPage, FixedPage, FixedPagesConf, ResDir, TauriConf, AIConf, ThemeConfig, ChainConf, ChainConfs } from "./file";
//
...
//   const chainConf = Convert.toChainConf(json);
//   const chainConfs = Convert.toChainConfs(json);
//
...
export class Convert {
    ...
    public static toChainConf(json: string): ChainConf {
        return cast(JSON.parse(json), r("ChainConf"));
    }

    public static chainConfToJson(value: ChainConf): string {
        return JSON.stringify(uncast(value, r("ChainConf")), null, 2);
    }

    public static toChainConfs(json: string): ChainConfs {
        return cast(JSON.parse(json), r("ChainConfs"));
    }

    public static chainConfsToJson(value: ChainConfs): string {
        return JSON.stringify(uncast(value, r("ChainConfs")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "ChainConfs": o([
        { json: "chains", js: "chains", typ: a(r("ChainConf")) },
    ], false),
    "ChainConf": o([
        { json: "label", js: "label", typ: "" },
        { json: "tables", js: "tables", typ: a("") },
    ], false),
