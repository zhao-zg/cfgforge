...
import {
    ...
    deleteRefsInPlace,
    getFieldObj,
    getFieldPrimitiveTypeConverter,
    isDeeplyEqual,
    prepareEditingObject
} from "./editingObjectUtils.ts";

// 会话注册表与纯 JSON 工具已迁至 editingObjectUtils.ts；此处 re-export 保持既有导入方不变
export {getCurrentEditingSession, isDeeplyEqual, setCurrentEditingSession} from "./editingObjectUtils.ts";
