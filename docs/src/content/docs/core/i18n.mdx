...
参考示例项目：[i18n_method1](https://github.com/stallboy/cfgforge/blob/master/example/i18n_method1)
...
node ../../packages/cli/dist/index.js -datadir ../config -i18nfile en.csv -gen i18n,file=en.csv
node ../../packages/cli/dist/index.js -datadir ../config -i18nfile kr.csv -gen i18n,file=kr.csv
node ../../packages/cli/dist/index.js -datadir ../config -i18nfile tw.csv -gen i18n,file=tw.csv
```
