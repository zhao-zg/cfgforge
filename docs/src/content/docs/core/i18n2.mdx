...
```bat
node ../../packages/cli/dist/index.js -datadir ../config -langswitchdir langs -gen i18nbyid,dir=langs,backup=backup
```
...
```bat
node ../packages/cli/dist/index.js -datadir config -langswitchdir i18n/langs -gen ...
```
...
```bat
node ../packages/cli/dist/index.js -datadir config -i18nfile i18n/langs/en -gen ...
```
