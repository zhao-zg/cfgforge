---
title: inside cfgforge
description: inside cfgforge
sidebar:
  order: 21
---

![arch](arch.png)
cfgforge 采用以 Context 为核心的模块化架构，通过统一的配置定义生成多语言代码。系统支持 Excel、CSV、JSON 等多种数据源，可输出 Java、C#、Go、Lua、TypeScript 等目标语言。
